    ...
    .then((data) => {
        ...
        data?.articles.forEach((articles) => {
            ...
            let item = parser.parseFromString(
                `
              <div  id=${articles.id
                } class="results-item relative overflow-hidden  flex bg-whiteFull  rounded-[10px] shadow-med">
              <a href=${articles.url
                } target="_blank" class="opacity-0 bg-[rgba(0, 0, 0, 0.656)] result-backdrop  absolute w-full h-full z-[1000]">
              </a>
                  <div class="flex">
                  <div href=${articles.url
